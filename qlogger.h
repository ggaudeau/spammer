...
namespace QLogger
{
	...
	*/
	enum LogLevel
	{
		TraceLevel = 0,	// ignored in release
		DebugLevel,		// ignored in release
		InfoLevel,		// ignored in release
		WarnLevel,
		ErrorLevel,
		FatalLevel
	};
	...
	*/
	...
	public:
		...
		*/
		void write(const QString &module, LogLevel level, const QString &message);
	private:
		/**
	...
	*/
	...
	public:
		...
		*/
		bool addDestination(const QString &fileDest, const Qt::HANDLE handle, const QString &modules, LogLevel level);
		...
		*/
		QString getModuleName(const Qt::HANDLE handle) const;
		QMutex mutex;
	private:
		/**
		...
		*/
		...
		QMap<Qt::HANDLE, QString> moduleNameMap;
		/**
